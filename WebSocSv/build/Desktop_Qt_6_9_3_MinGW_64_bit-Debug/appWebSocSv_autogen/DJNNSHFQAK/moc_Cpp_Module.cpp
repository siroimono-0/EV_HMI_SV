...
template <> constexpr inline auto Cpp_Module::qt_create_metaobjectdata<qt_meta_tag_ZN10Cpp_ModuleE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::MethodData<bool(QVariant)>(3, 2, QMC::AccessPublic, QMetaType::Bool, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
    QtMocHelpers::UintData qt_properties {
        // property 'hmi_md'
        QtMocHelpers::PropertyData<StatModel*>(6, 0x80000000 | 7, QMC::DefaultPropertyFlags | QMC::EnumOrFlag, 0),
    };
...
void Cpp_Module::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->set_webSoc_Sv((*reinterpret_cast< std::add_pointer_t<QVariant>>(_a[1])));
